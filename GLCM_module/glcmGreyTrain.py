...
def GLCM_Calculate(img_path,i,props=['dissimilarity','correlation','homogeneity','contrast','ASM','energy']):
    ...
    matrix_coocurrence = graycomatrix(inds, [1], [0], levels=256, normed=True, symmetric=True)
...
glcm_df.to_csv('C:/Users/Pradnya Deshmukh/Desktop/jupyter/GreytrainSet.csv')
